...
<div class="terms">
    <div class="default-container mb-[200px]">
        <h2 class="font-okana text-[4rem] font-black leading-normal mt-[120px] mx-auto mb-5">Privacy Policy</h2>
        <p>Last updated: 1 Oct 2023</p>
        <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>

        <h2 class="font-okana text-[4rem] font-black leading-normal mt-[120px] mx-auto mb-5">Interpretation and Definitions</h2>
        ...
        <ul class="mt-2">
            ...
            <li>Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to V3RIFIED.</li>
            ...
            <li>Country refers to: Hong Kong</li>
            ...
            <li>Website refers to V3RIFIED, accessible from https://v3rified.io/</li>
            <li>You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>

        <h2 class="font-okana text-[4rem] font-black leading-normal mt-[120px] mx-auto mb-5">Collecting and Using Your Personal Data</h2>
        <p class="title">Types of Data Collected</p>
        ...
        <p class="title">Tracking Technologies and Cookies</p>
        ...
        <h2 class="font-okana text-[4rem] font-black leading-normal mt-[120px] mx-auto mb-5">Use of Your Personal Data</h2>
        ...
        <h2 class="font-okana text-[4rem] font-black leading-normal mt-[120px] mx-auto mb-5">Retention of Your Personal Data</h2>
        ...
        <h2 class="font-okana text-[4rem] font-black leading-normal mt-[120px] mx-auto mb-5">Transfer of Your Personal Data</h2>
        ...
        <h2 class="font-okana text-[4rem] font-black leading-normal mt-[120px] mx-auto mb-5">Disclosure of Your Personal Data</h2>
        <p class="title">Business Transactions</p>
        <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
        <p class="title">Law enforcement</p>
        <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
        <p class="title">Other legal requirements</p>
        ...
        <h2 class="font-okana text-[4rem] font-black leading-normal mt-[120px] mx-auto mb-5">Security of Your Personal Data</h2>
...
<style lang="postcss">
    .terms {
        ...
        @apply overflow-y-scroll h-[100vh]
    }

    p {
        @apply mt-1 mb-3 leading-normal font-normal;
    }
    
    .title {
        @apply mt-8 font-bold mb-0 text-xl;
    }

    ul {
        @apply list-disc ml-5 gap-0;
    }
